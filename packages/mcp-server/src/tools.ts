...
// PURPOSE
// ============================================
// Defines input schemas for the MCP client tools registry, enabling type-safe
// parameter validation on client IDE calls.
...
export const TOOLS_REGISTRY: MCPToolDefinition[] = [
  {
    name: "search_pins",
